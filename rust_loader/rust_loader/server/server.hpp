...
namespace server
{
    ...
    namespace encryption
    {
        ...
        inline std::string SHA256_HASH_BINARY(const std::string& input) {
            SHA256 hash;
            std::string digest;
    ...
    inline std::string generate_respone_hash(std::string ch, std::string data)
    {
